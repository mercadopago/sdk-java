...
public class MPBaseTest extends MPBase {
    ...
    */
    ...
    public void methodPathTest() throws Exception {
        ...
        assertEquals("https://api.mercadopago.com/getpath/slug/test_id?access_token=" + SDK.getAccessToken(), resource.getLastApiResponse().getUrl());

        resource = create();
        assertEquals("POST", resource.getLastApiResponse().getMethod());
        assertEquals("https://api.mercadopago.com/postpath/slug?access_token=" + SDK.getAccessToken(), resource.getLastApiResponse().getUrl());
        ...
        assertEquals("https://api.mercadopago.com/putpath/slug/test_id?access_token=" + SDK.getAccessToken(), resource.getLastApiResponse().getUrl());
        ...
        resource.update();
        assertEquals("PUT", resource.getLastApiResponse().getMethod());
        assertEquals("https://api.mercadopago.com/putpath/slug/5?access_token=" + SDK.getAccessToken(), resource.getLastApiResponse().getUrl());
