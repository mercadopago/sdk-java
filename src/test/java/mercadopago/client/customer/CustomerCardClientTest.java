...
public class CustomerCardClientTest {
    ...
    public void getCardSuccess() throws IOException, MPException, ParseException {
        HttpResponse httpResponse = MockHelper.generateHttpResponseFromFile(responseFileSingleCard, 200);
    ...
    @Test
    public void createCardWithRequestOptionsSuccess() throws ParseException, IOException, MPException {
        MPRequestOptions requestOptions = MPRequestOptions.builder()
            .setAccessToken("abc")
            .setConnectionTimeout(1000)
            .setConnectionRequestTimeout(1000)
    ...
    @Test
    public void deleteCardWithRequestOptionsSuccess() throws MPException, IOException, ParseException {
        MPRequestOptions requestOptions = MPRequestOptions.builder()
            .setAccessToken("abc")
            .setConnectionTimeout(1000)
            .setConnectionRequestTimeout(1000)
    ...
    @Test
    public void listAllCardsWithRequestOptionsSuccess() throws IOException, MPException, ParseException {
        MPRequestOptions requestOptions = MPRequestOptions.builder()
            .setAccessToken("abc")
            .setConnectionTimeout(1000)
            .setConnectionRequestTimeout(1000)
