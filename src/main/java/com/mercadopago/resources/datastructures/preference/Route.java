...
public class Route {
    ...
    @Size(max=256) private String departure = null;
    @Size(max=256) private String destination = null;
    @Size(max=256) private Date departureDateTime = null;
    @Size(max=256) private Date arrivalDateTime = null;
    @Size(max=256) private String company = null;
