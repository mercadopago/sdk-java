...
/**
 * Mercado Pago SDK This resource allows you to create, modify or read payments
 *
...
public class Payment extends MPBase {
	...
	public enum OperationType {
		regular_payment, money_transfer, recurring_payment, account_fund, payment_addition, cellphone_recharge,
		pos_payment
	}
	...
	public enum PaymentTypeId {
		account_money, ticket, bank_transfer, atm, credit_card, debit_card, prepaid_card
	}
	...
	public static MPResourceArray search(Map<String, String> filters, Boolean useCache) throws MPException {
		return search(new HashMap<String, String>(filters), useCache);
	}
